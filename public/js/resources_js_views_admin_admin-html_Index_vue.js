...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  created: function created() {
    ...
    this.axios.get("".concat(this.$api, "admin/html")).then(function (response) {
    ...
    deleteHTML: function deleteHTML(html) {
      ...
      this.$swal({
        ...
        if (result.value) {
          ...
          _this2.axios.post("".concat(_this2.$api, "admin/html/delete"), formData).then(function (response) {
            _this2.$toast.success(response.data);
          })["catch"](function (error) {
            return _this2.$toast.error(error.response.data.message);
          })["finally"](function () {
            _this2.axios.get("".concat(_this2.$api, "admin/html")).then(function (response) {
                  ...
                  this.htmls.length === 0
                    ...
                    : _vm._l(_vm.htmls, function(html, key) {
                        return _c("tr", { key: html.id }, [
                          ...
                          _c("td", [
                            _vm._v(
                              _vm._s(new Date(html.created_at).toUTCString())
                            )
                          ]),
                          _vm._v(" "),
                          _c("td", { staticClass: "text-center" }, [
